...
create table if not exists incrementum.watchlist (
    id int primary key generated always as identity,
...
create table if not exists incrementum.watchlist_screener (
    watchlist_id int not null references incrementum.watchlist(id),
...
create table if not exists incrementum.watchlist_custom_screener (
    watchlist_id int not null references incrementum.watchlist(id),
