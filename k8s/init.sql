...
ALTER TABLE IF EXISTS incrementum.stock ADD COLUMN IF NOT EXISTS price INTEGER;
...
ALTER TABLE IF EXISTS incrementum.stock ADD COLUMN IF NOT EXISTS quarterly_financials_updated_at TIMESTAMP;
ALTER TABLE IF EXISTS incrementum.stock ADD COLUMN IF NOT EXISTS total_revenue BIGINT;
